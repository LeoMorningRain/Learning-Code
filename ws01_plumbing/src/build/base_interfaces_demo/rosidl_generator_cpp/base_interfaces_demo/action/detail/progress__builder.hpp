...
class Init_Progress_Result_num
{
public:
  Init_Progress_Result_num()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::base_interfaces_demo::action::Progress_Result num(::base_interfaces_demo::action::Progress_Result::_num_type arg)
  {
    msg_.num = std::move(arg);
    return std::move(msg_);
  }
...
{
  return base_interfaces_demo::action::builder::Init_Progress_Result_num();
}
