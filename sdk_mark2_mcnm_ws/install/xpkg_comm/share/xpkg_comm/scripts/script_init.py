...
print(Colors.GREEN + "Reloading udev and uart Services"+Colors.END)
# runCommand(["sudo", "systemctl", "stop", "nvgetty"],internal=True)
# print(Colors.GREEN + "If you see some thing like 'Failed to stop nvgetty.service: Unit nvgetty.service not loaded.', just ignore it. It will not cause anything to go wrong"+Colors.END)
