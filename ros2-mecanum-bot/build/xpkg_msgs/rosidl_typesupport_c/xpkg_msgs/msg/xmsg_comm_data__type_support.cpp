...
static const _XmsgCommData_type_support_symbol_names_t _XmsgCommData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xpkg_msgs, msg, XmsgCommData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xpkg_msgs, msg, XmsgCommData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xpkg_msgs, msg, XmsgCommData)() {
  return &::xpkg_msgs::msg::rosidl_typesupport_c::XmsgCommData_message_type_support_handle;
}
