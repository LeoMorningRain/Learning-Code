...
static const _XmsgDevice_type_support_symbol_names_t _XmsgDevice_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xpkg_msgs, msg, XmsgDevice)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xpkg_msgs, msg, XmsgDevice)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xpkg_msgs, msg, XmsgDevice)() {
  return &::xpkg_msgs::msg::rosidl_typesupport_c::XmsgDevice_message_type_support_handle;
}
